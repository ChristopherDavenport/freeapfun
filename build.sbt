...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/freeApFun"),
        "git@github.com:ChristopherDavenport/freeApFun.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/freeApFun")),
